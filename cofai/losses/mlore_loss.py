"""
MLoRE Loss Functions for CoFAI Framework
...
class RFCMultiTaskLoss(nn.Module):
    ...
    def __init__(self, p, tasks=None):
        ...
        from cofai.losses.loss_schemes import MultiTaskLoss as RFCLoss
        from cofai.utils.mlore_common_config import get_loss
