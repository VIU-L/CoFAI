"""
MLoRE Feature Compression Codec for CoFAI Framework

This module wraps the RFC's FeatCompression module to provide standard
LatentCodec interfaces compatible with the CoFAI framework.
...
class MLoREFeatureCodec(CompressionModel):
    ...
    def compress(self, x):
        ...
        Returns:
            dict following CoFAI coded_unit format:
...
class MLoREFeatureCodecWrapper(nn.Module):
    ...
    def __init__(self, feat_dim=768, N=1024, M=512):
        ...
        from cofai.backbone.mlore_transformers.MLoRE_coding_input_featcom import FeatCompression
